...
@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('vendor/cropper-master/dist/cropper.css') }}">
<script src="{{asset('js/tinymce/jquery.tinymce.min.js')}}"></script>
<script src="{{asset('js/tinymce/tinymce.min.js')}}"></script>
<script src="{{asset('vendor/cropper-master/dist/cropper.min.js')}}"></script>
@endsection
...
<div id="page-banner-edit" class="content-wrapper">
    <div class="container">
        ...
        <form method="post" action="{{ url('admin/banner/'. $banner->slug .'/edit') }}"  enctype="multipart/form-data" >
        	{!! csrf_field() !!}
        	<div class="row">
        		<div class="col-xs-9">
        			<div class="form-group">
	        			<div><label>Title</label></div>
	        			<div><input type="text" class="form-control" name="title" value="{{ $banner->title }}" /></div>
        			</div>
        		</div>
        	</div>
       		...
       		<div class="row form-group">
	        	<div class="col-xs-9">
                  ...
                  @if($banner->slide_img_path)
		        			<img id="slide-img" src="{{ $banner->slide_img_path }}" title="{{ $banner->title }}" alt="{{ $banner->title }}" /> 
                ...
                <input type="hidden" id="hasImgSet" name="hasImgSet" value="{{ ($banner->slide_img_path) ?'y' :'n' }}" />
			...
			<div class="row form-group">
	        	<div class="col-xs-9">
	        		<div class="form-group">
		        		...
		        		<div><input type="text" class="form-control" name="caption" value="{{ $banner->caption }}" /></div>
		        	</div>
	        	</div>
	        </div>
	        ...
	        <div class="row form-group">
	        	<div class="col-xs-9">
	        		...
	        		<textarea class="form-control editor" name="content" id="content" rows="10" cols="50">{{ $banner->content }}</textarea>
	        	</div>
	        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body clearfix">
          <div class="col-md-9">
            <div id="canvas"><img id="img-to-crop" src="{{ $banner->slide_img_path }}" /></div>
          </div>
          <div class="col-md-3">
